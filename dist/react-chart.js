(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define("react-chart", [], factory);
	else if(typeof exports === 'object')
		exports["react-chart"] = factory();
	else
		root["react-chart"] = factory();
})(window, function() {
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/Components/BarChart.css":
/*!***************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/Components/BarChart.css ***!
  \***************************************************************************/
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/Components/Common.css":
/*!*************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/Components/Common.css ***!
  \*************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/Components/LineChart.css":
/*!****************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/Components/LineChart.css ***!
  \****************************************************************************/
/*! no static exports found */
...
/***/ "./node_modules/css-loader/dist/cjs.js!./src/Components/PieChart.css":
/*!***************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./src/Components/PieChart.css ***!
  \***************************************************************************/
/*! no static exports found */
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./BarChart.css */ "./node_modules/css-loader/dist/cjs.js!./src/Components/BarChart.css");
...
var _Constants = __webpack_require__(/*! ./Constants */ "./src/Components/Constants.js");

var _ = __webpack_require__(/*! ./ */ "./src/Components/index.js");

__webpack_require__(/*! ./Common.css */ "./src/Components/Common.css");

__webpack_require__(/*! ./BarChart.css */ "./src/Components/BarChart.css");
...
var BarChart = exports.BarChart = function (_BaseChart) {
    ...
    _createClass(BarChart, [{
        ...
        value: function render() {
            ...
            data.forEach(function (dataSet, index) {
                var colorIndex = Math.floor(index / data.length * _Constants.colors.length);
                var color = dataSet.color || _Constants.colors[colorIndex];
                ...
                var legendItem = _this2._getLegend(dataSet.name, color);
...
var BaseChart = exports.BaseChart = function (_Component) {
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./Common.css */ "./node_modules/css-loader/dist/cjs.js!./src/Components/Common.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./LineChart.css */ "./node_modules/css-loader/dist/cjs.js!./src/Components/LineChart.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
__webpack_require__(/*! ./LineChart.css */ "./src/Components/LineChart.css");
...
var LineChart = exports.LineChart = function (_BaseChart) {
    ...
    _createClass(LineChart, [{
        ...
        value: function render() {
            ...
            data.forEach(function (dataSet, index) {
                ...
                var path = _react2.default.createElement('polyline', { key: dataSet.name,
                    points: pathData,
                    className: 'react-chart-line',
                    stroke: color,
                    strokeWidth: strokeWidth,
                    fill: _this2.props.fillArea ? color : 'none',
                    fillOpacity: _this2.props.fillArea ? 0.9 : 0,
                    strokeLinecap: 'round',
...
// load the styles
var content = __webpack_require__(/*! !../../node_modules/css-loader/dist/cjs.js!./PieChart.css */ "./node_modules/css-loader/dist/cjs.js!./src/Components/PieChart.css");
if(typeof content === 'string') content = [[module.i, content, '']];
// Prepare cssTransformation
var transform;
...
__webpack_require__(/*! ./PieChart.css */ "./src/Components/PieChart.css");
...
var PieChart = exports.PieChart = function (_BaseChart) {
    ...
    _createClass(PieChart, [{
        ...
        key: '_getArc',
        value: function _getArc(dataSetName, percent, startAngle, center, radius, arcColor) {
            var _this3 = this;

            var strokeWidth = 4;
            var isHovered = dataSetName === this.state.hovered;
            var radiusLessStroke = radius - strokeWidth;
            var angle = percent * Math.PI * 2;
            var x = Math.cos(startAngle) * radiusLessStroke + center;
            var y = Math.sin(startAngle) * radiusLessStroke + center;
            var endAngle = startAngle + angle;
            var x2 = Math.cos(endAngle) * radiusLessStroke + center;
            var y2 = Math.sin(endAngle) * radiusLessStroke + center;

            var closing = 'L ' + center + ' ' + center + ' Z';

            var large = endAngle - startAngle > Math.PI;

            if (this.props.donut) {
                var innerRadius = radiusLessStroke * this.props.donutThickness;
                var xInner = Math.cos(startAngle) * innerRadius + center;
                var yInner = Math.sin(startAngle) * innerRadius + center;
                var x2Inner = Math.cos(endAngle) * innerRadius + center;
                var y2Inner = Math.sin(endAngle) * innerRadius + center;

                closing = 'L ' + x2Inner + ' ' + y2Inner + '\n                A ' + innerRadius + ' ' + innerRadius + ', 0, ' + (large ? 1 : 0) + ', 0, ' + xInner + ' ' + yInner + ' Z';
            }

            return _react2.default.createElement('path', { key: dataSetName, d: 'M ' + x + ' ' + y + '\n                A ' + radiusLessStroke + ' ' + radiusLessStroke + ', 0, ' + (large ? 1 : 0) + ', 1, ' + x2 + ' ' + y2 + '\n                ' + closing,
                fill: arcColor,
                onMouseOver: function onMouseOver(event) {
                    return _this3._setTooltip(event, dataSetName, percent);
                },
                onMouseOut: function onMouseOut(event) {
                    return _this3._setTooltip(event, '');
                },
...
var _BaseChart = __webpack_require__(/*! ./BaseChart */ "./src/Components/BaseChart.js");
...
var _BarChart = __webpack_require__(/*! ./BarChart */ "./src/Components/BarChart.js");
...
var _LineChart = __webpack_require__(/*! ./LineChart */ "./src/Components/LineChart.js");
...
var _PieChart = __webpack_require__(/*! ./PieChart */ "./src/Components/PieChart.js");
...
//# sourceMappingURL=react-chart.js.map